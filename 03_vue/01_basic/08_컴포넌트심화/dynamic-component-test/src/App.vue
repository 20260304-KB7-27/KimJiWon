  ...
  <div class="header">
    ...
    <nav>
      <ul class="nav nav-tabs nav-fill">
        <li v-for="tab in tabs" :key="tab.id" class="nav-link">
          <a
...
import LeyteFulfTab from './components/LeyteFulfTab.vue';
import MidwayTab from './components/MidwayTab.vue';

export default {
  name: 'App',
  components: { CoralSeaTab, LeyteFulfTab, MidwayTab },
  data() {
    return {
